...
public class CacheStatistics
{
    ...
    public void WriteToFile(string path)
        ...
        .AddLine($"Total de leituras realizadas: {TotalExecutedReads}")
        .AddLine($"Total de escritas realizadas: {TotalExecutedWrites}")
        .AddLine($"Total de leituras e escritas realizadas: {TotalExecutions}")
        .AddLine($"Total de leituras realizadas na memória principal: {MainMemoryReads}")
        .AddLine($"Total de escritas realizadas na memória principal: {MainMemoryWrites}")
